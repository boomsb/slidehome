...
public class ApplicationsStackLayout extends ViewGroup implements View.OnClickListener {
    ...
    public ApplicationsStackLayout(Context context) {
        ...
        System.out.println("-->ApplicationsStackLayout.java: ApplicationsStackLayout(Context) Called"); 
    ...
    public ApplicationsStackLayout(Context context, AttributeSet attrs) {
        ...
        System.out.println("-->ApplicationsStackLayout.java: ApplicationsStackLayout(Context, AttributeSet) Called"); 
    ...
    private void initLayout() {
        ...
        System.out.println("-->ApplicationsStackLayout.java: initLayout Called"); 
    ...
    public int getOrientation() {
        ...
        System.out.println("-->ApplicationsStackLayout.java: getOrientation Called"); 
    ...
    protected void onDraw(Canvas canvas) {
        ...
        System.out.println("-->ApplicationsStackLayout.java: onDraw Called"); 
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        System.out.println("-->ApplicationsStackLayout.java: onMeasure Called"); 
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        System.out.println("-->ApplicationsStackLayout.java: onLayout Called"); 
        ...
        //mRecents? mFavorites? We don't need recents or favorites!
        mRecents = new ArrayList<ApplicationInfo>();
        mFavorites = new ArrayList<ApplicationInfo>();
    ...
    private void layoutVertical() {
        ...
        System.out.println("-->ApplicationsStackLayout.java: layoutVertical Called"); 
    ...
    private void layoutHorizontal() {
        ...
        System.out.println("-->ApplicationsStackLayout.java: layoutHorizontal Called"); 
    ...
    private int stackApplications(List<ApplicationInfo> applications, int childLeft, int childTop) {
        ...
        System.out.println("-->ApplicationsStackLayout.java: stackApplications Called"); 
        ...
        if (isVertical) System.out.println("**>I'm Vertical");
        	else System.out.println("**>I'm Horizontal");

        if (applications == null) System.out.println("**>applications is null");
    		else System.out.println("**>applications is fine");
        
        final int count = applications.size();
        
        System.out.println("**>There are "+count+ " applications");
    ...
    private void removeAllApplications() {
        ...
        System.out.println("-->ApplicationsStackLayout.java: removeAllApplications Called"); 
    ...
    private View createApplicationIcon(LayoutInflater inflater,
        ...
        System.out.println("-->ApplicationsStackLayout.java: createApplicationIcon Called"); 
    ...
    public void setFavorites(List<ApplicationInfo> applications) {
        ...
        System.out.println("-->ApplicationsStackLayout.java: setFavorites Called"); 
    ...
    /*public void setRecents(List<ApplicationInfo> applications) {
        ...
        System.out.println("-->ApplicationsStackLayout.java: setRecents Called"); 
    ...
    public void onClick(View v) {
        ...
        System.out.println("-->ApplicationsStackLayout.java: onClick Called"); 
